        ...
        Group {
            if firmware == "0" {
                ...
                Menu("Applets") {
                    ...
                    Button {
                        let game = Game(containerFolder: URL(string: "none")!, fileType: .item, fileURL: URL(string: "0x0100000000001000")!, titleName: "Home Menu (Broken)", titleId: "0", developer: "Nintendo", version: firmware)
                        self.gameHandler.currentGame = game
                    } label: {
